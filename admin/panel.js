...
.bha-box{position:relative;width:min(980px,100%);margin:auto;background:#1a1612;border:1px solid rgba(184,147,90,.28);font-family:'Poppins',sans-serif;color:#e8dcc8}
...
.bha-logo{font-family:'Lora',serif;font-size:1.15rem;letter-spacing:.18em;text-transform:uppercase;color:#faf7f2}.bha-logo span{color:#b8935a}
...
.bha-msg.err{background:rgba(196,92,92,.14);border:1px solid rgba(196,92,92,.4);color: #8a1f1f}
...
.bha-bv{background:rgba(90,158,111,.18);color: #1e4620;border:1px solid rgba(90,158,111,.28)}
...
.bha-calendar-date.blocked{background:rgba(196,92,92,.3);border-color:#c45c5c;color: #8a1f1f}
...
.bha-request-status.ok{background:rgba(90,158,111,.18);color: #1e4620;border-color:rgba(90,158,111,.28)}
...
.bha-modal-access-header > div:first-child{font-family:'Lora',Georgia,serif;font-size:1.25rem;color:#faf7f2;letter-spacing:.05em}
...
<div class="bha-head">
  ...
  <div class="bha-hbtns">
    <a href="hotel_admin.php" class="bha-btn ghost sm" id="bhaHotelAdmin" style="display:none; text-decoration:none;" target="_blank">🏨 Admin Hôtel</a>
    <a href="voiture_admin.php" class="bha-btn ghost sm" id="bhaCarAdmin" style="display:none; text-decoration:none;" target="_blank">🚘 Admin Voitures</a>
    <a href="compta.html" class="bha-btn ghost sm" id="bhaComptaAdmin" style="display:none; text-decoration:none;" target="_blank">📊 Bilan & Factures</a>
...
<div id="bhaAdmin" style="display:none">
  <div class="bha-tabs">
    ...
    <button class="bha-tab" data-tab="bhaTabClients">👥 Clients & Offres</button>
    <button class="bha-tab" data-tab="bhaTabExpenses">💸 Charges</button>
  </div>
  ...
  <div class="bha-pane" id="bhaTabEdit">
    ...
    <div class="bha-section">
      <div class="bha-section-title">Couleur visuelle distinctive (Attribution Villa)</div>
      <div class="bha-fg">
        <label class="bha-label">Code Couleur d'Accentuation de la Villa</label>
        <input class="bha-input" type="color" id="bhaFColor" value="#9C6F1C" style="height:44px;padding:4px">
      </div>
    </div>
  ...
  <div class="bha-pane" id="bhaTabPhotos">
    ...
    <div class="bha-drop" id="bhaDropZone">
      <input type="file" id="bhaFileInput" accept="image/jpeg,image/png,image/webp" multiple>
      <div style="font-size:.95rem;font-weight:500;color:#e8dcc8;margin-bottom:6px">📁 Glissez vos photos ici ou cliquez pour choisir</div>
      <div style="font-size:.74rem;color:#8a7d6a">JPG, PNG, WEBP — max 8 Mo par fichier</div>
    </div>
    <div style="display:flex;gap:8px;margin-bottom:16px">
      <input class="bha-input" type="text" id="bhaUrlInput" placeholder="Ou coller une URL d'image (https://...)" style="flex:1">
      <button type="button" class="bha-btn ghost sm" id="bhaAddUrlBtn">Ajouter URL</button>
    </div>
  ...
  <!-- TAB CLIENTS & MARKETING -->
  <div class="bha-pane" id="bhaTabClients">
    <div class="bha-msg" id="bhaClientsMsg"></div>
    <div class="bha-section">
      <div class="bha-section-title">👥 Base de Clients & Leads Auto-Capturés</div>
      <div id="bhaClientsListContainer"></div>
    </div>
    
    <div class="bha-section">
      <div class="bha-section-title">📢 Campagne Marketing / Relance Automatisée</div>
      <div class="bha-fg" style="margin-bottom:12px">
        <label class="bha-label">Titre de l'offre</label>
        <input class="bha-input" type="text" id="bhaCampTitle" placeholder="Ex: Offre Spéciale Saison — 15% de remise sur les villas">
      </div>
      <div class="bha-fg" style="margin-bottom:12px">
        <label class="bha-label">Canal de diffusion</label>
        <select class="bha-select" id="bhaCampChannel">
          <option value="all">WhatsApp + Email (Tous les clients)</option>
          <option value="whatsapp">WhatsApp Uniquement</option>
          <option value="email">Email Uniquement</option>
        </select>
      </div>
      <div class="bha-fg" style="margin-bottom:12px">
        <label class="bha-label">Message de relance / promotion</label>
        <textarea class="bha-textarea" id="bhaCampMsg" placeholder="Rédigez l'offre à envoyer aux prospects et clients enregistrés..."></textarea>
      </div>
      <button type="button" class="bha-btn" id="bhaSendCampaignBtn">🚀 Lancer la Campagne de Relance</button>
    </div>
  </div>

  <!-- TAB CHARGES / DÉPENSES -->
  <div class="bha-pane" id="bhaTabExpenses">
    <div class="bha-msg" id="bhaExpenseMsg"></div>
    
    <div class="bha-section">
      <div class="bha-section-title">➕ Saisir une nouvelle charge d'exploitation</div>
      <div class="bha-grid3">
        <div class="bha-fg">
          <label class="bha-label">Description de la charge</label>
          <input class="bha-input" type="text" id="bhaExpDesc" placeholder="Ex: Facture Senelec / Entretien Piscine">
        </div>
        <div class="bha-fg">
          <label class="bha-label">Montant (FCFA)</label>
          <input class="bha-input" type="number" id="bhaExpAmount" min="0" placeholder="Ex: 85000">
        </div>
        <div class="bha-fg">
          <label class="bha-label">Catégorie</label>
          <select class="bha-select" id="bhaExpCat">
            <option value="Entretien & Jardin">Entretien & Jardin</option>
            <option value="Énergie & Eau">Énergie & Eau</option>
            <option value="Personnel & Ménage">Personnel & Ménage</option>
            <option value="Taxes & Assurances">Taxes & Assurances</option>
            <option value="Marketing & Agence">Marketing & Agence</option>
            <option value="Divers">Divers</option>
          </select>
        </div>
        <div class="bha-fg">
          <label class="bha-label">Date</label>
          <input class="bha-input" type="date" id="bhaExpDate">
        </div>
        <div class="bha-fg">
          <label class="bha-label">Lié à une villa (Optionnel)</label>
          <select class="bha-select" id="bhaExpProperty">
            <option value="">-- Général / Toutes --</option>
          </select>
        </div>
      </div>
      <div style="margin-top:14px">
        <button type="button" class="bha-btn" id="bhaAddExpenseBtn">💸 Enregistrer la charge</button>
      </div>
    </div>

    <div class="bha-section">
      <div class="bha-section-title">📊 Bilan des Charges Enregistrées</div>
      <div id="bhaExpensesSummary"></div>
      <div id="bhaExpensesListContainer" style="margin-top:14px"></div>
    </div>
  </div>
...
function init(){
  ...
  var sendCampBtn = document.getElementById('bhaSendCampaignBtn');
  if(sendCampBtn) sendCampBtn.addEventListener('click', sendCampaign);
  var addExpBtn = document.getElementById('bhaAddExpenseBtn');
  if(addExpBtn) addExpBtn.addEventListener('click', addExpense);
  ...
  document.getElementById('bhaLogout').addEventListener('click',function(){
    api('/logout.php',{method:'POST'}).then(function(){
      ...
      var bhaCarAdmin = document.getElementById('bhaCarAdmin');
      if(bhaCarAdmin) bhaCarAdmin.style.display='none';
      var bhaComptaAdmin = document.getElementById('bhaComptaAdmin');
      if(bhaComptaAdmin) bhaComptaAdmin.style.display='none';
  ...
  /* add url */
  var addUrlBtn = document.getElementById('bhaAddUrl') || document.getElementById('bhaAddUrlBtn');
  if(addUrlBtn){
    addUrlBtn.addEventListener('click',function(){
      ...
      if(DB[CK].images.indexOf(u) === -1) DB[CK].images.push(u);
      document.getElementById('bhaUrlInput').value='';
      renderPhotos();
      saveAllWithMsg('bhaPhotoMsg','✅ URL ajoutée et enregistrée.',true,function(){ renderList(); });
    });
  }
...
function showAdmin(){
  ...
  var bhaCarAdmin = document.getElementById('bhaCarAdmin');
  if(bhaCarAdmin) bhaCarAdmin.style.display='inline-flex';
  var bhaComptaAdmin = document.getElementById('bhaComptaAdmin');
  if(bhaComptaAdmin) bhaComptaAdmin.style.display='inline-flex';
...
function ensurePhotoStructure(){
  if(!DB[CK]) return;
  if(!Array.isArray(DB[CK].images)) DB[CK].images=[];
  // Convertir photos{} si présent vers images[]
  if(DB[CK].photos && typeof DB[CK].photos === 'object' && !Array.isArray(DB[CK].photos)){
    var flat = [];
    ['exterieur','interieur','chambres'].forEach(function(c){
      if(Array.isArray(DB[CK].photos[c])){
        DB[CK].photos[c].forEach(function(u){
          if(u && flat.indexOf(u) === -1) flat.push(u);
        });
      }
    });
    if(flat.length > 0 && DB[CK].images.length === 0){
      DB[CK].images = flat;
    }
  }
}
...
function renderPhotos(){
  ...
  if(!container) return;
  ensurePhotoStructure();
  var imgs = DB[CK].images || [];
  if(!imgs.length){
    container.innerHTML = '<div style="color:#8a7d6a;font-size:.85rem;padding:24px;text-align:center;background:#0f0d0a;border:1px dashed rgba(184,147,90,.2);margin-top:16px">Aucune photo pour ce bien. Glissez-déposez vos photos ci-dessus pour commencer.</div>';
    return;
  }
  ...
  var imgsHtml = imgs.map(function(url, i){
    ...
    var isCover = (i === 0);
    return '<div class="bha-photo draggable" data-idx="'+i+'" draggable="true" style="cursor:grab">'
      + (isCover ? '<span style="position:absolute;top:5px;right:5px;background:#9C6F1C;color:#fff;font-size:.52rem;padding:2px 6px;font-weight:600;text-transform:uppercase;border-radius:2px;z-index:2">★ Couverture</span>' : '')
      + '<span class="bha-photo-n">'+(i+1)+'</span>'
      + '<img src="'+esc(src)+'" alt="" onerror="this.style.opacity=\'.25\'">'
      + '<div class="bha-photo-bar">'
      + '<button type="button" class="bha-btn ghost sm" data-act="cover" title="Définir comme photo principale"'+(isCover?' disabled':'')+'>★</button>'
      + '<button type="button" class="bha-btn ghost sm" data-act="up" title="Monter"'+(i===0?' disabled':'')+'>↑</button>'
      + '<button type="button" class="bha-btn ghost sm" data-act="down" title="Descendre"'+(i===imgs.length-1?' disabled':'')+'>↓</button>'
      + '<button type="button" class="bha-btn danger sm" data-act="del" title="Supprimer">✕</button>'
      + '</div></div>';
  }).join('');

  container.innerHTML = '<div class="bha-section">'
    + '<div class="bha-section-title" style="display:flex;justify-content:space-between;align-items:center"><span>Galerie photos ('+imgs.length+')</span> <span style="font-weight:normal;font-size:.72rem;color:#d4ab72">💡 Glissez-déposez les vignettes pour réordonner</span></div>'
    + '<div class="bha-pgrid" id="bhaPhotoDragGrid">'+imgsHtml+'</div>'
    + '</div>';
  ...
  // Glisser-déposer (HTML5 Drag & Drop) pour réordonner les cartes photos
  var draggedIdx = null;
  var pgrid = container.querySelector('#bhaPhotoDragGrid');
  if(pgrid){
    var cards = pgrid.querySelectorAll('.bha-photo');
    cards.forEach(function(card){
      card.addEventListener('dragstart', function(e){
        draggedIdx = parseInt(card.dataset.idx, 10);
        card.style.opacity = '0.4';
        card.style.border = '2px dashed #b8935a';
        e.dataTransfer.effectAllowed = 'move';
        e.dataTransfer.setData('text/plain', draggedIdx);
      });
      card.addEventListener('dragend', function(){
        card.style.opacity = '1';
        card.style.border = '1px solid rgba(184,147,90,.15)';
        cards.forEach(function(c){ c.style.borderColor = 'rgba(184,147,90,.15)'; });
      });
      card.addEventListener('dragover', function(e){
        e.preventDefault();
        e.dataTransfer.dropEffect = 'move';
        card.style.borderColor = '#7fcf9a';
      });
      card.addEventListener('dragleave', function(){
        card.style.borderColor = 'rgba(184,147,90,.15)';
      });
      card.addEventListener('drop', function(e){
        e.preventDefault();
        card.style.borderColor = 'rgba(184,147,90,.15)';
        var targetIdx = parseInt(card.dataset.idx, 10);
        if(draggedIdx !== null && draggedIdx !== targetIdx){
          var movedItem = DB[CK].images.splice(draggedIdx, 1)[0];
          DB[CK].images.splice(targetIdx, 0, movedItem);
          renderPhotos();
          renderList();
          msg('bhaPhotoMsg', '🔄 Ordre des photos modifié. Cliquez sur "Enregistrer les photos" pour sauvegarder.', true);
        }
      });
    });
  }
...
function handlePhotoAction(el){
  ...
  if(act === 'cover' && idx > 0){
    ...
    renderPhotos();
    renderList();
    msg('bhaPhotoMsg', '⭐ Photo de couverture définie en 1ère position.', true);
  ...
  chain.then(function(){
    ...
    if(errs.length){
      ...
      api('/properties.php').then(function(d){
        ...
        renderPhotos();
        renderList();
        msg('bhaPhotoMsg', '✅ '+total+' photo(s) uploadée(s) avec succès !', true);
      }).catch(function(){
...
function loadClients(){
  api('/clients.php').then(function(d){
    clientsList = d || [];
    renderClients();
  }).catch(function(){});
}
...
function renderClients(){
  var container = document.getElementById('bhaClientsListContainer');
  if(!container) return;
  if(!clientsList.length){
    container.innerHTML = '<p style="color:#8a7d6a">Aucun client ou lead enregistré pour le moment.</p>';
    return;
  }
  var html = '<table class="table" style="width:100%;border-collapse:collapse;font-size:0.82rem">'
    +'<thead><tr style="color:#8a7d6a;border-bottom:1px solid rgba(184,147,90,0.2)">'
    +'<th style="padding:8px;text-align:left">Client</th>'
    +'<th style="padding:8px;text-align:left">Contact</th>'
    +'<th style="padding:8px;text-align:left">Source</th>'
    +'<th style="padding:8px;text-align:left">Remise</th>'
    +'<th style="padding:8px;text-align:left">Marketing</th>'
    +'</tr></thead><tbody>';
  clientsList.forEach(function(c){
    var mBadge = c.marketing ? '<span class="bha-badge bha-bv">Oui (+1%)</span>' : '<span class="bha-badge bha-bt">Non</span>';
    html += '<tr style="border-bottom:1px solid rgba(184,147,90,0.1);color:#e8dcc8">'
      +'<td style="padding:8px"><strong>'+esc(c.name)+'</strong></td>'
      +'<td style="padding:8px">📞 '+esc(c.phone)+'<br>✉️ '+esc(c.email||'-')+'</td>'
      +'<td style="padding:8px">'+esc(c.source||'Inconnu')+'</td>'
      +'<td style="padding:8px"><strong style="color:#b8935a">'+(c.discount||1)+'%</strong></td>'
      +'<td style="padding:8px">'+mBadge+'</td>'
      +'</tr>';
  });
  html += '</tbody></table>';
...
function sendCampaign(){
  var title = document.getElementById('bhaCampTitle').value.trim();
  var message = document.getElementById('bhaCampMsg').value.trim();
  var channel = document.getElementById('bhaCampChannel').value;
  if(!message){ msg('bhaClientsMsg', 'Veuillez saisir un message de relance.', false); return; }
  api('/clients.php?action=send_campaign', {
    method: 'POST',
    headers: {'Content-Type': 'application/json'},
    body: JSON.stringify({title: title, message: message, channel: channel})
  }).then(function(r){
    msg('bhaClientsMsg', r.message || 'Campagne envoyée avec succès !', true);
  }).catch(function(e){ msg('bhaClientsMsg', e.message, false); });
}

/* ─── CHARGES & DÉPENSES ───────────────────────────────────── */
var expensesList = [];
function loadExpenses(){
  api('/expenses.php').then(function(d){
    expensesList = d || [];
    renderExpenses();
  }).catch(function(){});
}
...
function addExpense(){
  var desc = document.getElementById('bhaExpDesc').value.trim();
  var amount = parseFloat(document.getElementById('bhaExpAmount').value);
  var cat = document.getElementById('bhaExpCat').value;
  var date = document.getElementById('bhaExpDate').value || new Date().toISOString().split('T')[0];
  var propId = document.getElementById('bhaExpProperty').value;

  if(!desc || !amount){ msg('bhaExpenseMsg', 'Veuillez saisir une description et un montant.', false); return; }

  api('/expenses.php', {
    method: 'POST',
    headers: {'Content-Type': 'application/json'},
    body: JSON.stringify({action: 'add', description: desc, amount: amount, category: cat, date: date, property_id: propId})
  }).then(function(){
    msg('bhaExpenseMsg', 'Charge enregistrée !', true);
    document.getElementById('bhaExpDesc').value = '';
    document.getElementById('bhaExpAmount').value = '';
    loadExpenses();
  }).catch(function(e){ msg('bhaExpenseMsg', e.message, false); });
}
...
function deleteExpense(id){
  ...
  api('/expenses.php', {
    ...
    msg('bhaExpenseMsg', 'Charge supprimée.', true);
    loadExpenses();
  }).catch(function(e){ msg('bhaExpenseMsg', e.message, false); });
}

function renderExpenses(){
  var container = document.getElementById('bhaExpensesListContainer');
  var summary = document.getElementById('bhaExpensesSummary');
  if(!container) return;

  var total = 0;
  expensesList.forEach(function(e){ total += parseFloat(e.amount||0); });

  if(summary){
    summary.innerHTML = '<div style="display:flex;gap:16px;margin-bottom:12px">'
      +'<div style="background:rgba(196,92,92,0.15);border:1px solid #c45c5c;padding:12px 18px;border-radius:2px">'
      +'<div style="font-size:0.6rem;letter-spacing:0.18em;text-transform:uppercase;color:#c45c5c">Total des Charges</div>'
      +'<div style="font-size:1.4rem;color:#faf7f2;font-weight:600">'+total.toLocaleString('fr-FR')+' FCFA</div>'
      +'</div></div>';
  }

  if(!expensesList.length){
    container.innerHTML = '<p style="color:#8a7d6a">Aucune charge enregistrée.</p>';
    return;
  }
  ...
  expensesList.forEach(function(exp){
    html += '<tr style="border-bottom:1px solid rgba(184,147,90,0.1);color:#e8dcc8">'
      +'<td style="padding:8px"><small>'+esc(exp.date)+'</small></td>'
      +'<td style="padding:8px"><span class="bha-badge bha-bt">'+esc(exp.category)+'</span></td>'
      +'<td style="padding:8px"><strong>'+esc(exp.description)+'</strong></td>'
      +'<td style="padding:8px"><strong style="color:#c45c5c">'+Number(exp.amount).toLocaleString('fr-FR')+' FCFA</strong></td>'
      +'<td style="padding:8px"><button type="button" class="bha-btn danger sm" onclick="window._bhaDelExp(\''+exp.id+'\')">Supprimer</button></td>'
      +'</tr>';
  });
  html += '</tbody></table>';
  container.innerHTML = html;
}
window._bhaDelExp = deleteExpense;
